...
import com.skyworth.dpclientsdk.local.DeviceInfo;
...
public class TVDeviceInfo extends DeviceInfo {
    ...
    public static final Parcelable.Creator<TVDeviceInfo> CREATOR = new Parcelable.Creator<TVDeviceInfo>() {
        @Override
