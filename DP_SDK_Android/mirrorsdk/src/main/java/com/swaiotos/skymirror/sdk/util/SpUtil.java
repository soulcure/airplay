...
public class SpUtil {
    ...
    public interface Keys {
        String SP_FILE_NAME = "SP_SFICAST_SDK";
        String CONNECT_DEVICE_IP = "CONNECT_DEVICE_IP";
        String CONNECT_DEVICE_WIFI = "CONNECT_DEVICE_WIFI";
        String CONNECT_PREPARE_DEVICE_IP = "CONNECT_PREPARE_DEVICE_IP";
    }
    ...
    private static SharedPreferences getSp(Context context) {
        if (sp == null) {
            sp = context.getSharedPreferences(Keys.SP_FILE_NAME, Context.MODE_PRIVATE);
        }
        return sp;
    }
