...
import com.coocaa.publib.network.common.Constants;
...
public class ParamsUtil {
    ...
    public static HashMap<String, Object> getQueryMap(HashMap<String, Object> queryMap){
        ...
        pairs.put("appkey", com.coocaa.smartscreen.network.common.Constants.APP_KEY_TVPAI);
        ...
        sortedPairStr.append(com.coocaa.smartscreen.network.common.Constants.APP_SALT_TVPAI);
        Log.d(TAG,"sortUrlParameters after sort===== : " + sortedPairStr.toString());
        String signStr = sortedPairStr.toString();
        String sign = com.coocaa.smartscreen.network.util.MD5Util.getMD5String(signStr).toLowerCase(Locale.getDefault());
        pairs.put("sign", sign);
        return pairs;
    }
...
//        if (jsonArray.length() > 0)
    ...
    public static HashMap<String, String> getCoocaaAccountPublicMap(HashMap<String, String> queryMap, HashMap<String, String> fieldMap) {
        ...
        map.put("time", time);
        map.put("client_id", Constants.COOCAA_CLIENT_ID);
    ...
    private static String sortCoocaaAccountUrlParameters(HashMap<String, String> queryMap, HashMap<String, String> fieldMap){
        ...
        sortedPairStr.append(Constants.SIGN_COOCAA_SECRET);
