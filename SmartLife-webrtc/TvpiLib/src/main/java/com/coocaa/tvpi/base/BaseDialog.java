...
public class BaseDialog extends AppCompatDialog implements
    ...
    public BaseDialog(Context context) {
        this(context, R.style.dialog_style_dim_3);
    }
    ...
    public static final class AnimStyle {
        ...
        /** 默认动画效果 */
        static final int DEFAULT = com.coocaa.publib.R.anim.dialog_enter;
    ...
    public static class Builder<B extends Builder> {
        ...
        /** 主题 */
        private int mThemeId = R.style.dialog_style_dim_3;
        /** 动画 */
