 ...
 */
public abstract class BaseViewModelAppletActivity<VM extends BaseViewModel> extends BaseViewModelProvideAppletActivity implements LoadStateViewProvide {
    private static final String TAG = BaseViewModelAppletActivity.class.getSimpleName();
