...
public class UserAgreementDialog extends DialogFragment {
        ...
        agree.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(userAgreementListener != null){
                    userAgreementListener.onAgreeClick();
                }
            }
        });
    ...
    private SpannableStringBuilder createAgreementStringBuilder() {
        String userAgreementBeforeStr = "亲爱的用户，欢迎使用共享屏！\n" +
                "为了提供优质的用户体验和客户端的正常运行，共享屏 App 需要连网并对您的部分个人信息或权限进行收集与使用，您有权拒绝或取消授权。\n" +
                "在使用 App 之前，请您阅读并充分理解共享屏的";
        String userAgreementStr = "《用户协议》";
        String centerStr = "和";
        String privacyStr = "《隐私协议》";
        String privacyAfterStr = "，了解您的用户权益与相关数据的处理方法。点击同意表示您已经充分阅读并接受以上协议内容。我们将以业界领先的信息安全保护技术，保护您的个人信息，感谢您对共享屏的信任。";
