...
public class BigScreenPlayFunctionAdapter extends BaseQuickAdapter<FunctionBean, BaseViewHolder> {
    public BigScreenPlayFunctionAdapter() {
        super(R.layout.item_big_screen_play_function);
    }
