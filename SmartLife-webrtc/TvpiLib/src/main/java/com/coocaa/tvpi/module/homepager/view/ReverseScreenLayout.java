...
public class ReverseScreenLayout extends LinearLayout {
    ...
    public ReverseScreenLayout(@NonNull Context context) {
        this(context, null, 0);
    }

    public ReverseScreenLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ReverseScreenLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    private void initView() {
        LayoutInflater.from(getContext()).inflate(R.layout.layout_reverse_controller, this, true);
