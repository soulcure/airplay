...
public class DiscoverBannerAdapter extends BannerAdapter<FunctionBean, DiscoverBannerAdapter.BannerViewHolder> {

    private Context context;

    public DiscoverBannerAdapter(Context context,List<FunctionBean> datas) {
        super(datas);
