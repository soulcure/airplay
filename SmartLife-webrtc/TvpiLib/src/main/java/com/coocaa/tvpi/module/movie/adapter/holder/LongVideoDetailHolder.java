...
public class LongVideoDetailHolder extends RecyclerView.ViewHolder {

    private static final String TAG = LongVideoDetailHolder.class.getSimpleName();
    ...
    private View episodeMore, descMore, buyVip;
    ...
    public LongVideoDetailHolder(View itemView) {
        super(itemView);
        ...
        buyVip = itemView.findViewById(R.id.buy_vip_layout);
    }
    ...
    public void onBind(LongVideoDetailModel longVideoDetail) {
        ...
        if (null != mLongVideoDetail) {
            ...
            /*if (mLongVideoDetail.source.equals("iqiyi")) {
...
//                mPushTV.setText("推送第" + video.episodes + "集至电视");
        ...
        episodeMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                episodeDialogFragment.show(((Activity)itemView.getContext()).getFragmentManager(), EpisodeDialogFragment.DIALOG_FRAGMENT_TAG);
            }
        });
        descMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                descDialogFragment.show(((Activity)itemView.getContext()).getFragmentManager(), DescDialogFragment.DIALOG_FRAGMENT_TAG);
            }
        });
