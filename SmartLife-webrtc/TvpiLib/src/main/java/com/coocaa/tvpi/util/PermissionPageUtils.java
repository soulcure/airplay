...
public class PermissionPageUtils {
    ...
    //自己的项目包名
    private String packageName="com.coocaa.tvpi";
    private static PermissionPageUtils mPermissionPageUtils;
    private PermissionPageUtils(Context context) {
        this.mContext = context;
    }

    public synchronized static PermissionPageUtils getInstance(Context context) {
        if (mPermissionPageUtils == null) {
            mPermissionPageUtils = new PermissionPageUtils(context);
        }
        return mPermissionPageUtils;
    }
