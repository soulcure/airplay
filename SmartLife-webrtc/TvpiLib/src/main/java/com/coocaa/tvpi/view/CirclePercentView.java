...
public class CirclePercentView extends View {
    ...
    public CirclePercentView(Context context, AttributeSet attrs) {
        ...
        bgColor = typedArray.getColor(R.styleable.CirclePercentView_circleBgColor, getResources().getColor(R.color.circle_progress_gray));
        progressColor = typedArray.getColor(R.styleable.CirclePercentView_circleProgressColor, getResources().getColor(R.color.circle_progress_orange));
        radius = typedArray.getInt(R.styleable.CirclePercentView_circlePercentRadius, WIDTH_RADIUS_RATIO);
