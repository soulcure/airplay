...
public class DeviceItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DeviceItemDecoration setMargin(float margin) {
        this.margin = margin;
        return this;
    }

    //设置颜色
    public DeviceItemDecoration setColor(int color) {
        mPaint.setColor(color);
        return this;
    }

    //设置分割线高度
    public DeviceItemDecoration setDividerHeight(float height) {
