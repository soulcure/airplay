...
public class NotificationChannelCompat26 {
    ...
    private static NotificationChannel buildNIMMessageChannel() {
        NotificationChannel channel = new NotificationChannel(NIM_CHANNEL_ID, NIM_CHANNEL_NAME, NotificationManager.IMPORTANCE_LOW);
