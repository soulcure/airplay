...
public class SiriWaveView extends View {
    ...
    //颜色
    private int[] COLORS = {R.color.color_white_40, R.color.color_white_40, R.color.color_white_40};
    private int[] lineColors = new int[]{0x66ffffff, 0x66ffffff, 0x66ffffff, 0x66ffffff};
