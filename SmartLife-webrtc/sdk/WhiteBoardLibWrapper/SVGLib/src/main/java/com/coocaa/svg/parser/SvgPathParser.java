...
import com.coocaa.interfaces.IPathParser;
 ...
 * @author romainnurik
 */
public class SvgPathParser implements IPathParser {
  ...
  @Override
  public Path parse(String s) throws ParseException {
...
//      Log.d("SVG-Path", "command" + command);
      ...
      switch (command) {
        ...
        case 's': {
          ...
          while (advanceToNextToken() == TOKEN_VALUE) {
            ...
            consumeAndTransformPoint(tempPoint2, relative);
            consumeAndTransformPoint(tempPoint3, relative);
            p.rCubicTo(tempPoint1.x, tempPoint1.y, tempPoint2.x, tempPoint2.y, tempPoint3.x,
                    tempPoint3.y);
          }
          mCurrentPoint.set(tempPoint3);
          break;
...
//      Log.d("SVG-Path", "advanceToNextToken char=" + c);
      if ('a' <= c && c <= 'z') {
  ...
  private char consumeCommand() throws ParseException {
    advanceToNextToken();
//    Log.d("SVG-Path", "consumeCommand mCurrentToken=" + mCurrentToken);
  ...
  private float consumeValue() throws ParseException {
    ...
    try {
      ...
      mIndex = index;
//      Log.d("SVG-Path", "consumeValue : " + value);
      return value;
