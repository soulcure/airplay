...
import swaiotos.sensor.data.BusinessInfo;
...
public enum WhiteBoardClientSocket {
    ...
    private void initBusinessInfo(Context context, String clientSSID) {
        if(clientBusinessInfo == null) {
            ...
            int offsetX = 0;
            int offsetY = 0;
            clientBusinessInfo = new ClientBusinessInfo(TextUtils.isEmpty(clientSSID) ? WhiteBoardConfig.CLIENT_SS_ID : clientSSID,
                    WhiteBoardConfig.SERVER_SS_ID, "白板客户端",
