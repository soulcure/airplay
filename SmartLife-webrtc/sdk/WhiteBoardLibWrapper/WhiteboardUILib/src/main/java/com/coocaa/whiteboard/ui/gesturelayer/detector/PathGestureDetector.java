...
public class PathGestureDetector {
    ...
    public PathGestureDetector(PathGestureDetectorListener listener) {
    ...
    private void touchMove(MotionEvent event) {
        ...
        if (dx >= TOUCH_TOLERANCE || dy >= TOUCH_TOLERANCE) {
            ...
            if (listener != null) {
                ...
                listener.onPathChange(areaToRefresh, path);
    ...
    public interface PathGestureDetectorListener {
        ...
        void onPathChange(@Nullable Rect invalidRect, Path path);
    ...
    public static class SimpleGestureDetectorListener implements PathGestureDetectorListener {
        @Override
        public void onPathChange(@Nullable Rect invalidRect, Path path) {
        }
