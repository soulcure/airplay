...
import com.coocaa.whiteboard.ui.util.CubicEasing;
import com.coocaa.whiteboard.ui.util.RectUtils;
...
public class ProcessImageView extends TransformImageView {
    ...
    public static final float DEFAULT_MAX_SCALE_MULTIPLIER = 5f;
    ...
    protected void zoomImageToPosition(float scale, float centerX, float centerY, long durationMs) {
        ...
        post(mZoomImageToPositionRunnable = new ZoomImageToPosition(ProcessImageView.this,
        ...
        if (mBitmapLaidOut && !isImageWrapCropBounds()) {
            ...
            if (animate) {
                post(mWrapCropBoundsRunnable = new WrapCropBoundsRunnable(
                        ProcessImageView.this, mImageToWrapCropBoundsAnimDuration, currentX, currentY, deltaX, deltaY,
    ...
    private static class WrapCropBoundsRunnable implements Runnable {
        ...
        private final WeakReference<ProcessImageView> mCropImageView;
        ...
        public WrapCropBoundsRunnable(ProcessImageView cropImageView,
                                      long durationMs,
        ...
        @Override
        public void run() {
            ProcessImageView cropImageView = mCropImageView.get();
    ...
    private static class ZoomImageToPosition implements Runnable {
        ...
        public ZoomImageToPosition(ProcessImageView cropImageView,
                                   long durationMs,
                                   float oldScale, float deltaScale,
