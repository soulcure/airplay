...
public class WhiteboardSpUtil {

    // 不同的返回数据的key定义
    public static class Keys {
        public static final String IS_FIRST_ENTER_WHITEBOARD = "IS_FIRST_ENTER_WHITEBOARD";
    }
    ...
    private static SharedPreferences getSp(Context context) {
        if (sp == null) {
            sp = context.getSharedPreferences("WhiteBoardSp", Context.MODE_PRIVATE);
        }
        return sp;
    }
