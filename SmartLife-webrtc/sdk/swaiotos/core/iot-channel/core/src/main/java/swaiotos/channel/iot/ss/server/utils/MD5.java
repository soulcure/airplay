...
public class MD5 {
	...
	public static Map<String,String> getParamsSign(Map<String,String> params) {
		...
		sb.append("key=");
		sb.append(Constants.COOCAA_APIKEY);
		Log.d(MD5.class.getName(),""+sb.toString());
		String packageSign = encode(sb.toString()).toUpperCase();
		params.put(Constants.COOCAA_SIGN,packageSign);
