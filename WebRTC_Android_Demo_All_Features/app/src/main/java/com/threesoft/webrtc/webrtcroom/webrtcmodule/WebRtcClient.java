...
import com.threesoft.webrtc.webrtcroom.activity.MainActivity;
 ...
 * Created by zengjinllong on 2021/01/20.
 */

public class WebRtcClient {
    //Log Tag
    private final static String TAG = "WebRtcClient";//WebRtcClient.class.getCanonicalName()
