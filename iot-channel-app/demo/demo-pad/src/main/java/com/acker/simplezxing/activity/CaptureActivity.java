...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public static final String KEY_SCAN_HINT_TEXT = "KEY_SCAN_HINT_TEXT";
    ...
    private void bundleSetting(Bundle bundle) {
        ...
        scanHintText = bundle.getString(KEY_SCAN_HINT_TEXT, "");
    ...
    protected void onResume() {
        ...
        viewfinderView.setDrawText(scanHintText);
