    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            if (!TextUtils.isEmpty(drawText)) {
                ...
                _drawText = getResources().getString(R.string.hint_scan);
            }
            if (!TextUtils.isEmpty(_drawText)) {
                TextPaint paint = new TextPaint();
                paint.setColor(Color.WHITE);
                paint.setTextSize(ViewUtil.convertSpToPixels(16, getContext()));
                StaticLayout layout = new StaticLayout(_drawText, paint, width, Layout.Alignment.ALIGN_CENTER, 1.0F, 0.0F, false);
